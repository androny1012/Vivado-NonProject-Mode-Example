...
proc create_root_design { parentCell } {
  ...
  set sys_clk [ create_bd_port -dir I -type clk -freq_hz 33333329 sys_clk ]
  ...
  connect_bd_net -net clk_wiz_0_clk_50 [get_bd_pins clk_wiz_0/clk_50] [get_bd_pins top_0/sys_clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins top_0/rst_n]
